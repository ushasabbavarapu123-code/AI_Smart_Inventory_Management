...
**Generated At:** 2026-07-07 19:59:33
...
| :--- | :--- | :--- | :--- |
| Completeness | **99.55%** | Percentage of non-null cells in all tables. | Passed ✅ |
...
| Accuracy | **93.77%** | Percentage of records within expected limits (not needing IQR outlier capping). | Passed ✅ |
